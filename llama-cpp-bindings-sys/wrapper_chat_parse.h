...
typedef enum llama_rs_chat_parser_create_status {
    ...
    LLAMA_RS_CHAT_PARSER_CREATE_VENDORED_OUT_OF_MEMORY,
...
typedef enum llama_rs_chat_parser_free_status {
    ...
    LLAMA_RS_CHAT_PARSER_FREE_VENDORED_OUT_OF_MEMORY,
...
typedef enum llama_rs_parsed_chat_free_status {
    ...
    LLAMA_RS_PARSED_CHAT_FREE_VENDORED_OUT_OF_MEMORY,
...
typedef enum llama_rs_parsed_chat_tool_call_name_status {
    ...
    LLAMA_RS_PARSED_CHAT_TOOL_CALL_NAME_VENDORED_OUT_OF_MEMORY,
